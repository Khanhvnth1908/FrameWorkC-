...
namespace ArrayClass
{
    class ArrayClass
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The fist occurence of 42 is at " + Array.IndexOf(Arr, 42));

            Console.WriteLine("The Last occurence of 42 is at " + Array.LastIndexOf(Arr, 42));
            ...
            Console.WriteLine("Array that befor started");
